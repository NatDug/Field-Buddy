...
export default function SignupScreen() {
  ...
  const handleBypassSignUp = () => {
    Alert.alert(
      'Development Bypass', 
      'This will create a temporary account for testing. Continue?',
      [
        { text: 'Cancel', style: 'cancel' },
        { 
          text: 'Continue', 
          onPress: () => {
            Alert.alert('Welcome!', 'Temporary account created. You can now test the app features.');
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Create an account to start managing your farm</Text>
          </View>
